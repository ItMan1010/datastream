...
@Data
public class FileFormatEntity extends BaseEntity {
    /**
     * 文件唯一标识
     */
     ...
     */
    private List<FileSpecialEntity> fileSpecialList;
    /**
     * 文件数据行体
     */
    private FileBodyEntity fileBody;
    /**
     * ftp类型：1ftp、2sftp
     */
     ...
     * 文件处理过滤条件
     */
    private List<FileFilterEntity> fileFilterList;
    private Map<Integer, List<FileFilterEntity>> fileFilterMap;
    /**
     * 文件正文用于做数量累计字段map结构
     * key:字段标识、value:累计值
     */
