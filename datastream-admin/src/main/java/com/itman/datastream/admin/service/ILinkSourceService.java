...
import static com.itman.datastream.common.constant.DataStreamConstant.SOURCE_DATA_LINK_SOURCE_KEY_NAME;

public interface ILinkSourceService extends ITableCount {
    @RouteSource(SOURCE_DATA_LINK_SOURCE_KEY_NAME)
    Integer insertDataList(Long dataSourceId, String insertSql) throws DataStreamException;
    ...
    @RouteSource(SOURCE_DATA_LINK_SOURCE_KEY_NAME)
    void syncDataList(Long dataSourceId, List<String> insertSqlList) throws DataStreamException;

    @RouteSource(SOURCE_DATA_LINK_SOURCE_KEY_NAME)
    Long executeSelectRecordCountSql(Long dataSourceId, String selectSql) throws DataStreamException;

    @RouteSource(SOURCE_DATA_LINK_SOURCE_KEY_NAME)
    void updateDataList(Long dataSourceId, List<String> updateSqlList) throws DataStreamException;
