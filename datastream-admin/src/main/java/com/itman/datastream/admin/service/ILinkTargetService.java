...
import static com.itman.datastream.common.constant.DataStreamConstant.SOURCE_DATA_LINK_TARGET_KEY_NAME;

public interface ILinkTargetService{
    @RouteSource(SOURCE_DATA_LINK_TARGET_KEY_NAME)
    ...
    @RouteSource(SOURCE_DATA_LINK_TARGET_KEY_NAME)
    long getTableRecordCount(Long dataSourceId, String selectSql) throws DataStreamException;
}
