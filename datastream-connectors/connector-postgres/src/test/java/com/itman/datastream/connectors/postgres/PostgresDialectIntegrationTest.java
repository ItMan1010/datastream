...
/**
 * PostgreSQL 方言集成测试（Testcontainers 真实 PostgreSQL）。
...
public class PostgresDialectIntegrationTest {
    ...
    public static void startContainer() {
        try {
            ...
            assumeNoException("Docker/PostgreSQL unavailable, skipping integration test", e);
        }
    }
    ...
    @Test
    public void pagingByLimit_coversAllRowsOnRealPostgres() throws Exception {
